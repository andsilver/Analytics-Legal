		...
		init: function () {
			...
			this.ft.raise('init.ft.sorting').then(function(){
				...
				F.arr.each(self.ft.columns.array, function(col){
					if (col.sortable){
						col.$el.addClass('footable-sortable').append($('<span/>', {'class': 'footable-sort-indicator'}));
					}
				});
...
(function($, F){
	F.Paging = F.Component.extend(/** @lends FooTable.Paging */{
		...
		$create: function(){
			...
			this.$pagination = $('<ul/>', { 'class': 'pagination' }).on('click.footable', 'a.page-link', { self: this }, this._onPageClicked);
